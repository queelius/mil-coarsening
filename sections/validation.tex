...
dominated by the boundary: only $8$ of $20$ instance types on MUSK1
and $4$ of $20$ on MUSK2 are interior at the optimum, and
accordingly the weighted score residual is large
($\|M^\top D^{-1}(\bm Y - \hat{\bm p})\|_\infty = 24.8$ on MUSK1 and
$505$ on MUSK2), exactly because the KKT conditions, not the
