...
This appendix provides self-contained proofs of the three core theorems
and the continuous-feature extension stated in
\cref{sec:identifiability,sec:methodology}. The setup
